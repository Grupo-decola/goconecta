...
const Header = () => {
  ...
  return (
    ...
    <div className="header-top">
      <div className="logo">
       <img className="LogoGoConecta" src={logo} alt="Logo GoConecta" style={{ height: 100 }} />
      </div>
      ...
      <div className="header-actions">
        ...
        <a href="/anuncie" className="action-link">Anuncie sua propriedade</a>
        <a href="/ajuda" className="action-link">Ajuda</a>
        <a href="/minhas-viagens" className="action-link">Minhas Viagens</a>
        <a href="/beneficios" className="action-link">Benefícios Passaporte</a>
