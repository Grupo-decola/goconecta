...
function AnunciePage() {
  ...
  return (
    ...
    >
      <h2 style={{ color: "#DA7818" }}>
        🏡 Anuncie sua Propriedade e Conquiste Mais Hóspedes!
      </h2>
      <p>
        Tem uma casa, apartamento, chalé ou pousada incrível? Transforme seu
        espaço em uma fonte de renda extra anunciando aqui!
      </p>
      <ul>
        ...
        <li>
          📸 Destaque sua propriedade com fotos e descrições personalizadas.
        </li>
      </ul>
      ...
      <p style={{ marginTop: "1rem" }}>
        👉{" "}
        <button className="btn-comunidade" onClick={handleClick}>
          Comece agora e faça parte da nossa comunidade de anfitriões!
        </button>
      </p>
    </div>
  );
