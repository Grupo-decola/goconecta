import { Container, Title, SimpleGrid, Loader, Center, Text, Stack, Alert } from '@mantine/core';
import { IconInfoCircle } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import PackageCard from '../Components/PackageCard.jsx';
import Filters from '../Components/Filters.jsx';
import { fetchPackages } from '../services/Api.js';
...
export default function Packages() {
  ...
  const handleFilterChange = ({ destination, minPrice, maxPrice, startDate, endDate }) => {
          ...
          <Center py={{ base: 40, sm: 60 }}>
            <Stack align="center" gap="md">
              ...
              <Text size="sm" c="dimmed" ta="center" maw={400} px="sm">
                Tente ajustar os filtros ou explore outros destinos para encontrar o pacote ideal para sua viagem.
              </Text>
            </Stack>
          </Center>
        ) : (
